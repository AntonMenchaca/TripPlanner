  ...
  function getCurrLocation() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(function (position) {
        ...
        axios
          .get(`/maps/api/geocode/json?latlng=${lat},${lng}&sensor-false`)
          .then(({ data }) => {
            console.log(data);
    ...
    <ThemeProvider theme={theme}>
      <div className="landingPage">
        ...
        <div className="landing-page-interactions">
                ...
                <div>
                  ...
                  <div className="autocomplete-dropdown-container">
                    ...
                    {suggestions.map((suggestion, i) => {
                      ...
                      return (
                        <div
                          onClick={() => setAddressFrom(suggestion.description)}
                          key={`from-${suggestion}-${i}`}
                ...
                <div>
                  ...
                  <div className="autocomplete-dropdown-container">
                    ...
                    {suggestions.map((suggestion, i) => {
                      ...
                      return (
                        <div
                          onClick={() => setAddressTo(suggestion.description)}
                          key={`to-${suggestion}-${i}`}
                          {...getSuggestionItemProps(suggestion, {
                            className,
                            style,
          ...
          >
            {" "}
            {storeFrom.formatted_address && storeTo.formatted_address ? (
